...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=True):
		...
		# My code here
        if testing == False :            
            self.epsilon = math.exp(-1 * self.a * self.t) #math.cos(self.a*self.t)
            self.t = self.t + 1
    ...
    def learn(self, state, action, reward):
        ...
        #print "________________________________________", state
        ########### 
        ## TO DO ##
        ###########
...
def run():
    ...
    sim = Simulator(env, size=None, update_delay=0.01, display=True, log_metrics=True, optimized=True)
